...
var gravity = new Box2D.Common.Math.b2Vec2(0.0, -9.81);
var doSleep = true;
...
function cw_createChassisPart(body, vertex1, vertex2) {
  ...
  vertex_list.push(Box2D.Common.Math.b2Vec2.Make(0,0));
...
function cw_createWheel(radius, density) {
  ...
  var fix_def = new Box2D.Dynamics.b2FixtureDef();
  fix_def.shape = new Box2D.Collision.Shapes.b2CircleShape(radius);
...
function cw_createRandomCar() {
  ...
  car_def.vertex_list.push(new Box2D.Common.Math.b2Vec2(Math.random()*chassisMaxAxis + chassisMinAxis,0));
  car_def.vertex_list.push(new Box2D.Common.Math.b2Vec2(Math.random()*chassisMaxAxis + chassisMinAxis,Math.random()*chassisMaxAxis + chassisMinAxis));
  car_def.vertex_list.push(new Box2D.Common.Math.b2Vec2(0,Math.random()*chassisMaxAxis + chassisMinAxis));
  car_def.vertex_list.push(new Box2D.Common.Math.b2Vec2(-Math.random()*chassisMaxAxis - chassisMinAxis,Math.random()*chassisMaxAxis + chassisMinAxis));
  car_def.vertex_list.push(new Box2D.Common.Math.b2Vec2(-Math.random()*chassisMaxAxis - chassisMinAxis,0));
  car_def.vertex_list.push(new Box2D.Common.Math.b2Vec2(-Math.random()*chassisMaxAxis - chassisMinAxis,-Math.random()*chassisMaxAxis - chassisMinAxis));
  car_def.vertex_list.push(new Box2D.Common.Math.b2Vec2(0,-Math.random()*chassisMaxAxis - chassisMinAxis));
...
function cw_createFloor() {
  var last_tile = null;
  var tile_position = new Box2D.Common.Math.b2Vec2(-5,0);
...
function cw_createFloorTile(position, angle) {
  ...
  coords.push(new Box2D.Common.Math.b2Vec2(0,0));
  coords.push(new Box2D.Common.Math.b2Vec2(0,-groundPieceHeight));
  coords.push(new Box2D.Common.Math.b2Vec2(groundPieceWidth,-groundPieceHeight));
  coords.push(new Box2D.Common.Math.b2Vec2(groundPieceWidth,0));
...
function cw_mutatev(car_def, n, xfact, yfact)
{
    ...
    car_def.vertex_list.splice(n, 1, new Box2D.Common.Math.b2Vec2(x, y));
}
